...
def build_scan_payload(
    ...
    if (
        ...
        args.enabled_ext_product_search
        or args.enabled_ext_product_search == []
        or args.ext_product_search_dirs
        or args.ext_product_search_dirs == []
    ):
        if options is None:
            options = {"enabled_extended_product_search": enabled_ext_product_search}
        else:
            options["enabled_extended_product_search"] = enabled_ext_product_search
