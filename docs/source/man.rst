...
**qpc cred add --name=** *name* **--type=** *(network | vcenter | satellite | openshift | acs | ansible)* **--username=** *username* **(--password | --sshkeyfile=** *key_file* | --sshkey**)** **[--sshpassphrase]** **--become-method=** *(sudo | su | pbrun | pfexec | doas | dzdo | ksu | runas )* **--become-user=** *user* **[--become-password]** **[--token]**
...
**qpc cred list --type=** *(network | vcenter | satellite | openshift | acs | ansible)*
...
**qpc source add --name=** *name*  **--type=** *(network | vcenter | satellite | openshift | acs | ansible)* **--hosts** *ip_address* **--cred** *credential* **[--exclude-hosts** *ip_address* **]** **[--port=** *port* **]** **[--use-paramiko=** *(True | False)* **]** **[--ssl-cert-verify=** *(True | False)* **]** **[--ssl-protocol=** *protocol* **]** **[--disable-ssl=** *(True | False)* **]**
...
**qpc source list [--type=** *(network | vcenter | satellite | openshift | acs | ansible)* **]**
...
* Creating a new acs type credential
  ...
  ``qpc cred add --name acs_cred --type acs --token``
...
* Creating a new acs source
  ...
  ``qpc source add --name acs_source --type acs --hosts  acs-cluster.example.com --cred acs_cred``
